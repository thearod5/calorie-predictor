...
from cleaning.dataset import Dataset, decode_image_from_path
...
def read_resize_save_image(input_image_path: str, output_image_path: str, settings: ProcessingSettings):
    try:
        ...
        image = decode_image_from_path(input_image_path)
    ...
    def process(self, settings: ProcessingSettings) -> "ImageFolderProcessor":
        ...
        for entry_name in image_paths:
            ...
            for entry_output in entry_outputs:
                ...
                error = read_resize_save_image(input_path, output_path, settings)
